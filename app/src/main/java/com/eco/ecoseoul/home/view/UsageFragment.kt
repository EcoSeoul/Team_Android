    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        when(arguments.getInt("usage")){
            1->{//전기
                ...
                waveView.setWaveColor(Color.parseColor("#00000000"),Color.parseColor("#FADE43"))
            ...
            2->{//수도
                ...
                waveView.setWaveColor(Color.parseColor("#00000000"),Color.parseColor("#4486F0"))
            ...
            3->{//도시가스
                ...
                waveView.setWaveColor(Color.parseColor("#00000000"),Color.parseColor("#D5B1FF"))
